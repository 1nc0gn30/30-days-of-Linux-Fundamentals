...
var NON_OVERRIDABLE_ASTRO_ATTRS = ["data-astro-transition", "data-astro-transition-fallback"];
var scriptsAlreadyRan = /* @__PURE__ */ new Set();
...
var restoreFocus = ({ activeElement, start, end }) => {
  if (activeElement) {
    activeElement.focus();
    if (activeElement instanceof HTMLInputElement || activeElement instanceof HTMLTextAreaElement) {
...
var persistedHeadElement = (el, newDoc) => {
  const id = el.getAttribute(PERSIST_ATTR);
...
//# sourceMappingURL=chunk-UMECPOFD.js.map
