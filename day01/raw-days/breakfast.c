...
void display_lesson(const char *command, const char *description, const char *examples) {
    printf("Lesson on `%s`:\n", command);
    printf("%s\n", description);
    printf("Examples:\n%s\n", examples);
...
int main() {
    ...
    ask_question("1. What command lists all files and directories in the current directory?", "ls");
    ask_question("2. What command changes the current directory?", "cd");
    ask_question("3. What command creates a new file?", "touch");
    ask_question("4. What command removes a file?", "rm");
    ask_question("5. What command shows the current working directory?", "pwd");
    ask_question("6. What command creates a new directory?", "mkdir");
    ask_question("7. What command copies files or directories?", "cp");
    ask_question("8. What command moves or renames files or directories?", "mv");
